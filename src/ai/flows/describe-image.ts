...
/**
 * @fileOverview A Genkit flow to describe an image using a multimodal AI model.
 *
...
const prompt = ai.definePrompt({
  ...
  prompt: `You are an expert at describing items for a lost and found system.
  
  Analyze the following image and provide a concise but detailed description of the item.
  Focus on key identifying features like color, brand, material, and any unique marks.
